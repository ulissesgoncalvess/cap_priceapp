...
N8N_SIMULATOR_WEBHOOK_URL = "https://automacoes-n8n.infrassys.com/webhook/CPONE"

# (A URL do workflow 'CAP_PRICE_CHAT_API')
N8N_CHAT_WEBHOOK_URL = "https://automacoes-n8n.infrassys.com/webhook/CPONE"
# -----------------------------------------------------------------
    ...
    try:
        ...
        try:
            ...
            if 'output' in n8n_json:
                ...
                return jsonify({"status": "error", "message": "Resposta da IA não é um JSON válido.", "data": response_n8n.text}), 500
